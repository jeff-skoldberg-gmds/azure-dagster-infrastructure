...
# Environment variables as Outputs
ACR_RG = pulumi.Output.from_input(os.getenv("ACR_RG"))
ACR_NAME = pulumi.Output.from_input(os.getenv("ACR_NAME"))
IMAGE_TAG = pulumi.Output.from_input(os.getenv("IMAGE_TAG"))
IMAGE_NAME_USER_CODE = pulumi.Output.from_input(os.getenv("IMAGE_NAME_USER_CODE"))
IMAGE_NAME_DAEMON = pulumi.Output.from_input(os.getenv("IMAGE_NAME_DAEMON"))
IMAGE_NAME_WEB_SERVER = pulumi.Output.from_input(os.getenv("IMAGE_NAME_WEB_SERVER"))
SUBSCRIPTION_ID = pulumi.Output.from_input(os.getenv("SUBSCRIPTION_ID"))
...
DAGSTER_POSTGRES_PASSWORD = pulumi.Output.from_input(os.environ["DAGSTER_POSTGRES_PASSWORD"])
...
DAGSTER_POSTGRES_PORT = pulumi.Output.from_input(os.environ["DAGSTER_POSTGRES_PORT"])
USER_CODE_HOST = "usercode"
USER_CODE_PORT = pulumi.Output.from_input(os.environ["USER_CODE_PORT"])
